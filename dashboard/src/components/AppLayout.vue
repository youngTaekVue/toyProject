                    ...
                    <ul>
                        <li>
                            <router-link to="/dashboard" active-class="active"
                                ><v-icon>mdi-view-dashboard</v-icon> <span>Dashboard</span></router-link
                            >
                        </li>
                        <li>
                            <router-link to="/analytics" active-class="active"
                                ><v-icon>mdi-chart-bar</v-icon> <span>Analytics</span></router-link
                            >
                        </li>

                        <li>
                            <router-link to="/billing" active-class="active"
                                ><v-icon>mdi-wallet</v-icon> <span>Billing</span></router-link
                            >
                        </li>
                        <li>
                            <a
                                @click="accountDropdown"
                                :class="{ active: isAccountDropdownOpen }"
                                class="collapsible-activator"
                            >
                            ...
                            <ul v-if="isAccountDropdownOpen" class="collapsible-submenu">
                                <li>
                                    <router-link to="/dropdown/subitem1" active-class="active"
                                        ><span>Account Overview</span></router-link
                                    >
                                </li>
                                <li>
                            ...
                            <ul v-if="isHealthOpen" class="collapsible-submenu">
                                <li>
                                    <router-link to="/health/healthDashboard" active-class="active"
                                        ><span>Health Dashboard</span></router-link
                                    >
                                </li>
                            </ul>
                        </li>
                            ...
                            <ul v-if="isStatistics" class="collapsible-submenu">
                                <li>
                                    <router-link to="/error-statistics" active-class="active"
                                        ><v-icon>mdi-alert-circle-outline</v-icon> <span>Error Monitoring</span></router-link
                                    >
                                </li>
                            </ul>
                        </li>
                        <li>
                            <router-link to="/profile" active-class="active"
                                ><v-icon>mdi-account-circle</v-icon> <span>Profile</span></router-link
                            >
                        </li>
                        <li>
                            <router-link to="/settings" active-class="active"
                                ><v-icon>mdi-cog</v-icon> <span>Settings</span></router-link
                            >
                        </li>
                    </ul>
                </nav>
...
.summary-cards h3,
.summary-cards h4 {
    /* Added h4 for new dashboard cards */
